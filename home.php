    ...
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 mb-5">Temukan beragam koleksi literatur kami, pinjam buku favorit Anda, dan
                    nikmati pengalaman membaca yang memikat dengan sistem pencarian yang mudah di situs web kami.</p>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mt-0">Berkumpul di Antara Halaman di Antara Ribuan Buku</h2>
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="container  card-p-2" style="min-width: 18rem;">
                            ...
                            <img type="button" class="btn btn-outline-secondary p" data-bs-toggle="modal"
                                data-bs-target="#modaldesc<?php echo $no; ?>" src="assets/buku/<?php echo $data['foto'] ?>"
