...
<head>
    ...
    <link href="css/2styles.css" rel="stylesheet" />
...
<body class="sb-nav-fixed" style="background-color: rgb(255, 255, 255   )">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5 ">
            <a class="navbar-brand" href="?page=home">Arsip Hikayat Lumina</a>
            ...
            <div class="collapse navbar-collapse " id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    if ($_SESSION['user']['level'] != 'admin' && $_SESSION['user']['level'] != 'petugas') {
                        ...
                        <li class="nav-item"><a class="nav-link" href="?page=ulasan_User">Ulasan Saya</a></li>
                        <?php
                    }
                    ?>
                    <li class="nav-item"><a class="nav-link" href="?page=ulasan">Ulasan Buku</a></li>
                    ...
                    <!-- <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <form class="d-flex" onsubmit="return searchPage()">
                            <input type="text" id="nav_search" class="form-control" autocomplete="off"
                    ...
                    <script>
                        ...
                        function searchPage() {
                            ...
                            var searchQuery = document.getElementById("nav_search").value;
                           
                            window.location.href = "?page=cari&query=" + encodeURIComponent(searchQuery);
